...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#detailBtn").click(function () {
            $.ajax({
                url:"workbench/clue/clueDetail.do",
                type:"get",
                dataType:"json",
                data:{
                    "id":"77d3c3103658421394b9c6de62c01d44"
                },
                success:function () {
                    window.location.href="workbench/clue/detail.jsp"
                }
            })
        })
		...
		$("#addBtn").click(function () {
			//弹出模态窗口前，查询用户列表
			$.ajax({
				url:"workbench/clue/selectUserList.do",
				data:{
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" id="detailBtn" onclick="window.location.href='workbench/clue/detail.jsp';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
