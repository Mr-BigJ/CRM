...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#detailBtn").click(function () {
			window.location.href="workbench/transaction/getTranDetail.do?tranId=23f698dffb87424babdc3be08edf6f44";
		})
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" id="detailBtn">动力节点-交易01</a></td>
							<td>动力节点</td>
							<td>谈判/复审</td>
							<td>新业务</td>
							<td>zhangsan</td>
