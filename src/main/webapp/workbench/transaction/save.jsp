		...
		$("#create-stage").change(function () {
			$.ajax({
				...
				success:function (data) {
					//v=$("#create-stage").val()
					//{{"01":"10"},{},}
					var va=data[$("#create-stage").val()]
					$("#create-possibility").val(va)
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" method="post" action="workbench/transaction/saveTran.do" id="savetranForm">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="755f0f6607b34f7e9c8cb5bcdc91fb86" name="aid">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="杜聚斌">
				<input type="hidden" value="36cde18ebe414e1fbf597fbd87a32e69" name="conid">
			</div>
		</div>
